...
public:
	 ...
	 */
	virtual bool GetTargetingLocation(APlayerController* PlayerController, UGridWorldSubsystem* GridSubsystem, 
		float Range, int RotationOffset, FTransform& OutResult) { return false; }
	 ...
	 */
	virtual bool CanPlace(UGridWorldSubsystem* GridSubsystem, FTransform QueryTransform) { return false; }
};
